// ==UserScript==
// @name         Bonk.io Jump HACK - Bonkio Hacks - Best Bonk Cheat 2019 to 2020
...
// @updateURL    https://io-mods.com/mods/bonkio.user.js
// @downloadURL  https://io-mods.com/mods/bonkio.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://bonk.io/*
// @match        *iogames.space/*
...
text += '<a href="http://'+value+'" target="_blank" style="'+ministyler+'">'+value2+' <font color="#555555">-</font></a>';
    ...
    //ozellikler
    var fts = ["Auto Jump","Auto Spawn","Auto Skin","Jump Hack","Speed Hack","Anti Lag","Anti Ads","Free Skins","Move Hack","Full Screen","Ghost Skin"];
...
//degisenkisimlar
$('#templatemo_menu').html('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
$('#templatemo_main').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div></br>');
$('#gamethumbcontainer').html('<div class="list1"></div>'+this.st.imagelist+'');
...
document.getElementById("flashblocktext").prepend(br);
document.getElementById("flashblocktext").prepend(stylerSelect);
...
function changebackground() {
    ...
    $("body").css("background-color",rgbaC2);
}
